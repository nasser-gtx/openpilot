...
def wrong_car_mode_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int, personality) -> Alert:
  text = "فعّل مثبّت السرعة التكيّفي للتفعيل"
  if CP.brand == "honda":
...
class SoftDisableAlert(Alert):
  def __init__(self, alert_text_2: str):
    super().__init__("تولّ القيادة فوراً", alert_text_2,
...
class UserSoftDisableAlert(SoftDisableAlert):
  def __init__(self, alert_text_2: str):
    ...
    self.alert_text_1 = "سيتوقف القائد الآلي"
...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "أبقِ يديك على المقود وعينيك على الطريق دائماً", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
